# Define: ssh::client::match
#
# Apply a set of keywords to matching tokens.
#
# Examples:
#
#   ssh::client::match { 'all':
#     addkeystoagent => 'yes',
#   }
#
#   ssh::client::match { 'user ubnt exec "test -r %d/.ssh/ubnt_id_rsa"':
#     identityfile => '~/.ssh/ubnt_id_rsa',
#   }
#
define ssh::client::match (
  ...
  concat::fragment { "ssh_config-host-${name}":
    ...
    content => template('ssh/sshd_config-match.erb'), # ssh_config looks like sshd_config
  }
}
